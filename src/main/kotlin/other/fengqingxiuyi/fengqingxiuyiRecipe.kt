...
import com.github.fengqingxiuyi.androidstudioplugintemplate.listeners.MyProjectManagerListener.Companion.projectInstance
import com.intellij.openapi.roots.ProjectRootManager
import com.intellij.psi.PsiDirectory
import com.intellij.psi.PsiFileFactory
import com.intellij.psi.PsiManager
import org.jetbrains.kotlin.idea.KotlinLanguage
import other.fengqingxiuyi.src.app_package.someActivity
import other.fengqingxiuyi.src.app_package.someActivityLayout

fun RecipeExecutor.fengqingxiuyiSetup(
    ...
    generateManifest(moduleData, activityClass, activityTitle, packageName,
            ...
            requireTheme = true, useMaterial2 = false)
